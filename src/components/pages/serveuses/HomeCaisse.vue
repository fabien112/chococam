                ...
                <div class="col">
                  <div class="card h-100 card-lift">
                    <div class="card-body">
                      ...
                      <div class="mt-4 mb-2">
                        <h3 class="fw-bold mb-0">{{ posts.nombre }}</h3>
                      </div>
                ...
                <div class="col">
                  <div class="card h-100 card-lift">
                    <div class="card-body">
                      ...
                      <div class="mt-4 mb-2">
                        <h3 class="fw-bold mb-0">{{ posts.som }} F</h3>
                      </div>
...
export default {
  ...
  async mounted() {
    if (!localStorage.users) {
      ...
      this.forms.caisse = this.users.caisse.id;

      const response2 = await this.callApi(
        "post",
        process.env.VUE_APP_URL_API + "api/dashboardadmin",
        this.forms
      );
