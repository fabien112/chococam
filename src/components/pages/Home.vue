  ...
  <main id="main-wrapper" class="main-wrapper">
    ...
    <div id="app-content">
      ...
      <div class="app-content-area">
        <div
          class="pt-10 pb-21 mt-n6 mx-n4"
          style="background-color: #471101"
        ></div>
...
export default {
  ...
  async mounted() {
    if (!localStorage.users) {
      ...
      // // afficher du plus petit restant au plus grand en stock

      // this.posts3 = this.posts2.sort((a, b) => (a.stock > b.stock ? 1 : -1));
    }
  },
};
</script>
