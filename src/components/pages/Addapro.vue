                ...
                <div class="">
                  <div class="row">
                    ...
                    >
                      ...
                      <div class="col-md-4">
                        <label class="m-4" for> Prix achat unitaire </label>
  ...
  methods: {
    ...
    add2(index) {
      if (this.forms.inputs2[index].produit == "") {
        ...
        return this.e("Vous devez mentionner une quantite");
      } else if (
        this.forms.inputs2[index].prix == "" ||
        isNaN(this.forms.inputs2[index].prix == true)
      ) {
