        ...
        <Modal v-model="modal" title="Nouvelle caissière">
            <div class="row">
                ...
                <div class="col-12 pt-3">
                    <Upload multiple type="drag" :action="urlFile" :on-error="handleError"
                        :on-format-error="handleFormatError" :on-exceeded-size="handleMaxSize"
                        :format="['jpg', 'jpeg', 'png']" :max-size="2048" :on-success="handleSuccess">
        ...
        <div id="app-content">
            ...
            <div class="app-content-area">
                ...
                <div class="container-fluid mt-n22">
                    <h2 style="color: #41160a">Liste des Devices </h2>
                                            ...
                                            <table class="table text-nowrap mb-0 table-centered table-hover">
                                                <thead style="background-color: #41160a;">
                                                    <tr>
                                                        ...
                                                        <!-- <th style="color: white"> Coordonnées </th> -->

                                                        <th style="color: white"> Régions </th>
                                                ...
                                                <tbody>
                                                    <tr v-for="(data, i) in listes.tablistdem" :key="i">

                                                        <td>{{
                                                            (data.dateoperation.split('')[0] +
                                                                data.dateoperation.split('')[1] +
                                                                data.dateoperation.split('')[2] +
                                                                data.dateoperation.split('')[3] + '-' +
                                                                data.dateoperation.split('')[4] +
                                                                data.dateoperation.split('')[5] + "-" +
                                                                data.dateoperation.split('')[6] +
                                                                data.dateoperation.split('')[7])
                                                        ...
                                                        <td>
                                                            <span class="badge badge-danger-soft">
                                                                {{
                                                                    (data.heureoperation.split('')[0] +
                                                                        data.heureoperation.split('')[1]
                                                                        + " : " +
                                                                        data.heureoperation.split('')[2] +
                                                                        data.heureoperation.split('')[3])
                                                        ...
                                                        <!-- <td>
                                                            ...
                                                            <span class="badge badge-success-soft"
                                                                v-if="data.bApprovente == true">
                                                                Abouti

                                                            </span>

                                                            <span class="badge badge-danger-soft"
                                                                v-if="data.bApprovente == false">
                                                                Non abouti
                                                        ...
                                                        <td>
                                                            ...
                                                            <router-link to="maps" target="_blank">
                                                                <button @click="geolocate(data)"
                                                                    title="Geolocalisation du point"
    ...
    methods: {
        ...
        async show() {
            if (this.datedebut == "") {
                ...
                this.axios
                    .post(
                        process.env.VUE_APP_URL_API + "startup/liststart",
                        this.forms,
                        {
                            headers: {
